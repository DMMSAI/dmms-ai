...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "dryads-ai", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Dryads AI. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Dryads AI Issue Label Audit");
