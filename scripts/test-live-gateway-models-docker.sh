...
docker run --rm -t \
  ...
  -e DMMS_AI_LIVE_GATEWAY_MODELS="${DMMS_AI_LIVE_GATEWAY_MODELS:-${CLAWDBOT_LIVE_GATEWAY_MODELS:-all}}" \
  -e DMMS_AI_LIVE_GATEWAY_PROVIDERS="${DMMS_AI_LIVE_GATEWAY_PROVIDERS:-${CLAWDBOT_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e DMMS_AI_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${DMMS_AI_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${CLAWDBOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
