...
function mergeIMessageAccountConfig(cfg: DryadsAiConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: DryadsAiConfig): ResolvedIMessageAccount[] {
