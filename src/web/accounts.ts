...
export function listWhatsAppAuthDirs(cfg: DryadsAiConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: DryadsAiConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: DryadsAiConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: DryadsAiConfig): ResolvedWhatsAppAccount[] {
