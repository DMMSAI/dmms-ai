...
export function listWhatsAppAuthDirs(cfg: DmmsAiConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: DmmsAiConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: DmmsAiConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: DmmsAiConfig): ResolvedWhatsAppAccount[] {
