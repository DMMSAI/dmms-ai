...
/**
 * Convert an Dryads AI auth-profiles credential to pi-coding-agent auth.json format.
 ...
 *
 * Dryads AI stores credentials in auth-profiles.json instead. This helper
