...
describe("createDmmsAiCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createDmmsAiCodingTools({
      config,
    ...
    const anthropicTools = createDmmsAiCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createDmmsAiCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createDmmsAiCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
