...
function resolveAdaptiveReadMaxBytes(options?: DmmsAiReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createDmmsAiReadTool(base, {
...
export function createDmmsAiReadTool(
  base: AnyAgentTool,
  options?: DmmsAiReadToolOptions,
): AnyAgentTool {
