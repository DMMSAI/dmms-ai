...
function resolveAdaptiveReadMaxBytes(options?: DryadsAiReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createDryadsAiReadTool(base, {
...
export function createDryadsAiReadTool(
  base: AnyAgentTool,
  options?: DryadsAiReadToolOptions,
): AnyAgentTool {
