...
describe("createDryadsAiCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createDryadsAiCodingTools({
      config,
    ...
    const anthropicTools = createDryadsAiCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createDryadsAiCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createDryadsAiCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
