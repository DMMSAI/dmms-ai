...
function resolveWatchPaths(workspaceDir: string, config?: DmmsAiConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: DmmsAiConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: DmmsAiConfig }) {
