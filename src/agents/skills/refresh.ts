...
function resolveWatchPaths(workspaceDir: string, config?: DryadsAiConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: DryadsAiConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: DryadsAiConfig }) {
