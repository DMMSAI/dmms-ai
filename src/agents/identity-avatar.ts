...
function resolveAvatarSource(cfg: DmmsAiConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: DmmsAiConfig, agentId: string): AgentAvatarResolution {
