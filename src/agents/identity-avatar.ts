...
function resolveAvatarSource(cfg: DryadsAiConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: DryadsAiConfig, agentId: string): AgentAvatarResolution {
