...
export const DEFAULT_SANDBOX_IMAGE = "dryads-ai-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "dryads-ai-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "dryads-ai-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "dryads-ai-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "dryads-ai-sbx-browser-";
