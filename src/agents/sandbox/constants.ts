...
export const DEFAULT_SANDBOX_IMAGE = "dmms-ai-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "dmms-ai-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "dmms-ai-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "dmms-ai-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "dmms-ai-sbx-browser-";
