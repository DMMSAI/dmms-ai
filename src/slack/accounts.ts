...
function mergeSlackAccountConfig(cfg: DmmsAiConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: DmmsAiConfig): ResolvedSlackAccount[] {
