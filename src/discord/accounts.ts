...
function mergeDiscordAccountConfig(cfg: DryadsAiConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: DryadsAiConfig): ResolvedDiscordAccount[] {
