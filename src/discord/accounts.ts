...
function mergeDiscordAccountConfig(cfg: DmmsAiConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: DmmsAiConfig): ResolvedDiscordAccount[] {
