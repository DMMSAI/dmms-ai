...
const resolveStorePath = vi.fn(() => "/tmp/dryads-ai-discord-process-test-sessions.json");
...
beforeEach(() => {
  ...
  resolveStorePath.mockReturnValue("/tmp/dryads-ai-discord-process-test-sessions.json");
});
