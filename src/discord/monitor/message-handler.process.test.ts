...
const resolveStorePath = vi.fn(() => "/tmp/dmms-ai-discord-process-test-sessions.json");
...
beforeEach(() => {
  ...
  resolveStorePath.mockReturnValue("/tmp/dmms-ai-discord-process-test-sessions.json");
});
