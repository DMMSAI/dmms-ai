...
export const A2UI_PATH = "/__dmmsai__/a2ui";

export const CANVAS_HOST_PATH = "/__dmmsai__/canvas";

export const CANVAS_WS_PATH = "/__dmmsai__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.dmmsAiCanvasA2UIAction.postMessage(...)
  // - Android: window.dmmsAiCanvasA2UIAction.postMessage(...)
  const handlerNames = ["dmmsAiCanvasA2UIAction"];
  ...
  globalThis.DMMS AI = globalThis.DMMS AI ?? {};
  globalThis.DMMS AI.postMessage = postToNode;
  globalThis.DMMS AI.sendUserAction = sendUserAction;
  globalThis.dmmsAiPostMessage = postToNode;
  globalThis.dmmsAiSendUserAction = sendUserAction;
