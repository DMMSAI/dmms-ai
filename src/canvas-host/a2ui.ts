...
export const A2UI_PATH = "/__dryadsai__/a2ui";

export const CANVAS_HOST_PATH = "/__dryadsai__/canvas";

export const CANVAS_WS_PATH = "/__dryadsai__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.dryadsAiCanvasA2UIAction.postMessage(...)
  // - Android: window.dryadsAiCanvasA2UIAction.postMessage(...)
  const handlerNames = ["dryadsAiCanvasA2UIAction"];
  ...
  globalThis.Dryads AI = globalThis.Dryads AI ?? {};
  globalThis.Dryads AI.postMessage = postToNode;
  globalThis.Dryads AI.sendUserAction = sendUserAction;
  globalThis.dryadsAiPostMessage = postToNode;
  globalThis.dryadsAiSendUserAction = sendUserAction;
