...
export function applyVercelAiGatewayProviderConfig(cfg: DryadsAiConfig): DryadsAiConfig {
...
export function applyVercelAiGatewayConfig(cfg: DryadsAiConfig): DryadsAiConfig {
