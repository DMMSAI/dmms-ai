...
export function applyVercelAiGatewayProviderConfig(cfg: DmmsAiConfig): DmmsAiConfig {
...
export function applyVercelAiGatewayConfig(cfg: DmmsAiConfig): DmmsAiConfig {
