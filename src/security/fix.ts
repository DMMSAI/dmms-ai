...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof DmmsAiConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: DmmsAiConfig; env: NodeJS.ProcessEnv }): {
  cfg: DmmsAiConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
