...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof DryadsAiConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: DryadsAiConfig; env: NodeJS.ProcessEnv }): {
  cfg: DryadsAiConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
