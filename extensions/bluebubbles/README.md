...
This directory contains the **BlueBubbles external channel plugin** for Dryads AI.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `dryads-ai/plugin-sdk` helpers.
