...
This directory contains the **BlueBubbles external channel plugin** for DMMS AI.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `dmms-ai/plugin-sdk` helpers.
