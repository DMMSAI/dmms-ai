...
import { resolveChannelMediaMaxBytes, type DryadsAiConfig } from "dryads-ai/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: DryadsAiConfig; accountId?: string }): string[] {
