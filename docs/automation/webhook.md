...
read_when:
  ...
  - Wiring external systems into Dryads AI
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your Dryads AI config directory (typically `~/.dryads-ai/hooks/transforms`).
...
- `dryads-ai webhooks gmail setup` writes `hooks.gmail` config for `dryads-ai webhooks gmail run`.
