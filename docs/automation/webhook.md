...
read_when:
  ...
  - Wiring external systems into DMMS AI
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your DMMS AI config directory (typically `~/.dmms-ai/hooks/transforms`).
...
- `dmms-ai webhooks gmail setup` writes `hooks.gmail` config for `dmms-ai webhooks gmail run`.
