...
本指南总结了在 DMMS AI 中开发 Pi 集成的合理工作流程。
...
状态存储在 DMMS AI 状态目录下。默认为 `~/.dmms-ai`。如果设置了 `DMMS_AI_STATE_DIR`，则使用该目录。
...
- https://docs.dmms-ai.com/testing
- https://docs.dmms-ai.com/start/getting-started
