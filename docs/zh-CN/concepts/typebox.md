...
- 生成的 Swift 模型：`apps/macos/Sources/DryadsAiProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/dryads-ai/dryads-ai/main/dist/protocol.schema.json
