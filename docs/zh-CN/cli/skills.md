...
summary: "`dryads-ai skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
```bash
dryads-ai skills list
dryads-ai skills list --eligible
dryads-ai skills info <name>
dryads-ai skills check
```
