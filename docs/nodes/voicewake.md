...
Dryads AI treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.dryads-ai/settings/voicewake.json`

Shape:

```json
{ "triggers": ["dryads-ai", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
