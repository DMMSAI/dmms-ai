...
DMMS AI treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.dmms-ai/settings/voicewake.json`

Shape:

```json
{ "triggers": ["dmms-ai", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
