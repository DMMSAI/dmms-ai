...
read_when:
  - Setting up Zalo Personal for DMMS AI
...
- Install via CLI: `dmms-ai plugins install @dmms-ai/zalouser`
- Or from a source checkout: `dmms-ai plugins install ./extensions/zalouser`
...
- `dmms-ai pairing list zalouser`
- `dmms-ai pairing approve zalouser <code>`
...
- On startup, DMMS AI resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `dmms-ai channels logout --channel zalouser && dmms-ai channels login --channel zalouser`
