...
read_when:
  - Setting up Zalo Personal for Dryads AI
...
- Install via CLI: `dryads-ai plugins install @dryads-ai/zalouser`
- Or from a source checkout: `dryads-ai plugins install ./extensions/zalouser`
...
- `dryads-ai pairing list zalouser`
- `dryads-ai pairing approve zalouser <code>`
...
- On startup, Dryads AI resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `dryads-ai channels logout --channel zalouser && dryads-ai channels login --channel zalouser`
