---
summary: "Use Synthetic's Anthropic-compatible API in DMMS AI"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. DMMS AI registers it as the
...
Note: DMMS AI's Anthropic client appends `/v1` to the base URL, so use
