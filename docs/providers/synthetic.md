---
summary: "Use Synthetic's Anthropic-compatible API in Dryads AI"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Dryads AI registers it as the
...
Note: Dryads AI's Anthropic client appends `/v1` to the base URL, so use
