---
summary: "Use Qianfan's unified API to access many models in DMMS AI"
read_when:
...
3. DMMS AI installed on your system
...
4. Copy the API key for use with DMMS AI

## CLI setup

```bash
dmms-ai onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [DMMS AI Configuration](/gateway/configuration)
