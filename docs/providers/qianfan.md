---
summary: "Use Qianfan's unified API to access many models in Dryads AI"
read_when:
...
3. Dryads AI installed on your system
...
4. Copy the API key for use with Dryads AI

## CLI setup

```bash
dryads-ai onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Dryads AI Configuration](/gateway/configuration)
