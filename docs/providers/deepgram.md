...
Deepgram is a speech-to-text API. In DMMS AI it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, DMMS AI uploads the audio file to Deepgram and injects the transcript
