...
Deepgram is a speech-to-text API. In Dryads AI it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Dryads AI uploads the audio file to Deepgram and injects the transcript
