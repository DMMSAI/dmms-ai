---
summary: "Use NVIDIA's OpenAI-compatible API in DMMS AI"
read_when:
  - You want to use NVIDIA models in DMMS AI
...
dmms-ai onboard --auth-choice skip
dmms-ai models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
