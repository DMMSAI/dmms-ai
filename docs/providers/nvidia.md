---
summary: "Use NVIDIA's OpenAI-compatible API in Dryads AI"
read_when:
  - You want to use NVIDIA models in Dryads AI
...
dryads-ai onboard --auth-choice skip
dryads-ai models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
