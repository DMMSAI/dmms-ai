...
You can point DMMS AI at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or DMMS AI
...
- [Anthropic provider](/providers/anthropic) - Native DMMS AI integration with Claude setup-token or API keys
