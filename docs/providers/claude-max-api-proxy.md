...
You can point Dryads AI at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Dryads AI
...
- [Anthropic provider](/providers/anthropic) - Native Dryads AI integration with Claude setup-token or API keys
