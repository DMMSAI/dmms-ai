...
- Same path: run the app from a fixed location (for Dryads AI, `dist/DryadsAi.app`).
...
Workaround: move files into the Dryads AI workspace (`~/.dryads-ai/workspace`) if you want to avoid per-folder grants.
