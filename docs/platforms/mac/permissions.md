...
- Same path: run the app from a fixed location (for DMMS AI, `dist/DmmsAi.app`).
...
Workaround: move files into the DMMS AI workspace (`~/.dmms-ai/workspace`) if you want to avoid per-folder grants.
