...
Deploy DMMS AI on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/dmms-ai` — Control UI
...
- `DMMS_AI_STATE_DIR=/data/.dmms-ai` (recommended)
- `DMMS_AI_WORKSPACE_DIR=/data/workspace` (recommended)
- `DMMS_AI_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your DMMS AI state + workspace so you can migrate to another host without losing config or memory.
