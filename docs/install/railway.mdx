...
Deploy Dryads AI on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/dryads-ai` — Control UI
...
- `DRYADS_AI_STATE_DIR=/data/.dryads-ai` (recommended)
- `DRYADS_AI_WORKSPACE_DIR=/data/workspace` (recommended)
- `DRYADS_AI_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Dryads AI state + workspace so you can migrate to another host without losing config or memory.
