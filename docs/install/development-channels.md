...
Dryads AI ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Dryads AI also aligns
the install method:
...
When you switch channels with `dryads-ai update`, Dryads AI also syncs plugin sources:
