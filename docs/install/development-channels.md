...
DMMS AI ships three update channels:
...
When you **explicitly** switch channels with `--channel`, DMMS AI also aligns
the install method:
...
When you switch channels with `dmms-ai update`, DMMS AI also syncs plugin sources:
