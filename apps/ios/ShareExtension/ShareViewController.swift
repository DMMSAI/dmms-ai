...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.dryadsai.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to Dryads AI", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to Dryads AI gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to Dryads AI.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "DryadsAiShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "Dryads AI is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "Dryads AI Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("dryads-ai-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
