...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: DmmsAiPhotosLatestParams) async throws -> DmmsAiPhotosLatestPayload {
        ...
        var results: [DmmsAiPhotoPayload] = []
        ...
        return DmmsAiPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> DmmsAiPhotoPayload
    {
