...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: DryadsAiPhotosLatestParams) async throws -> DryadsAiPhotosLatestPayload {
        ...
        var results: [DryadsAiPhotoPayload] = []
        ...
        return DryadsAiPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> DryadsAiPhotoPayload
    {
