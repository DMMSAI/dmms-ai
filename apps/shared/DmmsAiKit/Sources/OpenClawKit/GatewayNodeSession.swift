...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.dmmsai", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.dmmsai", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: DmmsAiProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
