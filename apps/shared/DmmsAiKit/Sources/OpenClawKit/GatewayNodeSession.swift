...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.dryadsai", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.dryadsai", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: DryadsAiProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
