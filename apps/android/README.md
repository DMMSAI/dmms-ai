## DMMS AI Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_dmms-ai-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm dmms-ai gateway --port 18789 --verbose
```
