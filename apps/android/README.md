## Dryads AI Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_dryads-ai-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm dryads-ai gateway --port 18789 --verbose
```
