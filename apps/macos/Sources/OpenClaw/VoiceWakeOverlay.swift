...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.dryadsai", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Dryads AI windows, but below the system’s pop-up menus.
