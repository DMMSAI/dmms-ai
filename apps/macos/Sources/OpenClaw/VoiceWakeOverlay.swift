...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.dmmsai", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other DMMS AI windows, but below the system’s pop-up menus.
