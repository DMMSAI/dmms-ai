...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .dryadsAiSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? DryadsAiPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? DryadsAiPaths.stateDirURL.path
...
extension Notification.Name {
    static let dryadsAiSelectSettingsTab = Notification.Name("dryadsAiSelectSettingsTab")
}
