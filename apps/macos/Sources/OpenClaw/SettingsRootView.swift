...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .dmmsAiSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? DmmsAiPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? DmmsAiPaths.stateDirURL.path
...
extension Notification.Name {
    static let dmmsAiSelectSettingsTab = Notification.Name("dmmsAiSelectSettingsTab")
}
