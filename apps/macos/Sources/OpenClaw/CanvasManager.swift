...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.dryadsai", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Dryads AI/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__dryadsai__/a2ui/").absoluteString + "?platform=macos"
    }
