...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.dmmsai", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("DMMS AI/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__dmmsai__/a2ui/").absoluteString + "?platform=macos"
    }
