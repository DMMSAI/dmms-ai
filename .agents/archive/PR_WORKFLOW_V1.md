...
- During `prepare-pr`, use this commit subject format: `fix: <summary> (dryads-ai#<PR>) thanks @<pr-author>`.
...
- Read `docs/help/submitting-a-pr.md` ([Submitting a PR](https://docs.dryads-ai.com/help/submitting-a-pr)) for what we expect from contributors.
